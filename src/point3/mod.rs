    ...
    fn sum<I: Iterator<Item = Self>>(iter: I) -> Self {
        ...
        iter.fold(
            Point3 {
                ...
                y: -0.0,
                z: -0.0,
            }, // in the macro's source code it also uses -0.0
            |a, b| a + b,
        )
    }
}
...
pub fn rotate_y(p: &Point3, cos_theta: f64, sin_theta: f64) -> Point3 {
    Point3 {
        x: cos_theta * p.x - sin_theta * p.z,
        y: p.y,
        z: sin_theta * p.x + cos_theta * p.z,
    }
}
...
pub fn random_vector(a: f64, b: f64) -> Point3 {
    Point3 {
        x: rand::random_range(a..b),
        y: rand::random_range(a..b),
        z: rand::random_range(a..b),
    }
}
...
pub fn refract(uv: Point3, n: Point3, eta_inital_over_eta_final: f64) -> Point3 {
    ...
    let parallel_component: Point3 = (-n)
        * ((1.0 - perpendicular_component.length_squared())
            .abs()
            .sqrt());
